...
if (isset($_POST['sbm1'])) {
    ...
    $sql_ord = "INSERT INTO orders(name1,phone,mail,address1,date1,timestamp,totals_price,status)
                VALUES ('$name','$phone','$mail','$address','$date',$stamp,'$total', 3)";
    ...
    while ($row1 = mysqli_fetch_array($query)) {
        ...
        if (isset($_POST['name1']) && isset($_POST['phone']) && isset($_POST['mail']) && isset($_POST['address1'])) {
            $query_detail = mysqli_query($conn, "INSERT INTO order_details(id,prd_id,prd_count,prd_price) VALUES ('$id','$prd_id','$prd_count','$prd_price')");
        }
...
//Port to connect smtp
    ...
    $email->CharSet = 'UTF-8';
//Set gmail username
    $email->Username = "anh.nvh187290@sis.hust.edu.vn";
//Set gmail password
    $email->Password = "hoanganhdzz";
//Email subject
