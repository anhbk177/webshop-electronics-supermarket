...
$list_page .= '<li class="page-item"><a class="page-link" href="index.php?page_layout=ship&page=' . $prev . '">&laquo;</a></li>';
// Số page
for ($i = 1; $i <= $total_page; $i++) {
    ...
    $list_page .= '<li class="page-item ' . $active . '"><a class="page-link" href="index.php?page_layout=ship&page=' . $i . '">' . $i . '</a></li>';
}
// Next
$next = $page + 1;
if ($next >= $total_page) {
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <table style="width: 100%; border-style:double; margin-top:20px; border-collapse:collapse;">
                        ...
                        <!-- thông tin -->
                        <?php
                        $sql = "SELECT*FROM orders WHERE status <3 ORDER BY timestamp DESC LIMIT $per_row,$row_per_page";
                        ...
                        ?>
                            <tr>
                                ...
                                <th style="border-style:double; border-collapse:collapse; padding-left:5px;">
                                    <a href="index.php?page_layout=ship_details&id=<?php echo $row['order_id']; ?>">Xem đơn hàng</a>
                                </th>
                            </tr>
                        <?php
                        }
