...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
   ...
   if(isset($_POST['id']) && !isset($_POST['name']) && $_POST['name']==''){
    ...
    $link = "id='.$id.'";
    $where = "user_id =.'$id'.";
}elseif(!isset($_POST['id']) && isset($_POST['name'])  && $_POST['id']==''){
   $name = $_POST['name'];
   $link = "name='.$name.'";
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <form id="product-search-form" action="index.php?page_layout=user&&id=<?php echo $link; ?>" method="POST">
                    <fieldset>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php if ($row['user_level'] == 0) {
                                            echo '<span class="label label-danger">Admin</span>';
                                        } elseif ($row['user_level'] == 2) {
                                            echo '<span class="label label-success">Stocker</span>';
                                        } else {
