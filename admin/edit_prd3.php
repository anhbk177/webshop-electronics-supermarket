...
$sql1 = "SELECT*FROM property_details WHERE prd_id = '$prd_id ' AND pro_id=6";
$query1 = mysqli_query($conn, $sql1);
$row1 = mysqli_fetch_array($query1);

$sql2 = "SELECT*FROM property_details WHERE prd_id = '$prd_id ' AND pro_id=5";
...
if (isset($_POST['sbm'])) {
    ...
    $sql1x = "UPDATE property_details SET pdt_val=('$type') WHERE prd_id = '$prd_id ' AND pro_id=2";
    $query1x = mysqli_query($conn, $sql1x);

    $sql2x = "UPDATE property_details SET pdt_val=('$inverter ') WHERE prd_id = '$prd_id ' AND pro_id=4";
                    ...
                    <div class="col-md-6">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input required name="capacity" value="635 lít" type="text" class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <option value=1>Mini</option>
                                            <option value=1 selected>Tủ lớn - Side by side</option>
                                    <option value=1 >Ngăn đá dưới</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div>
                                ...
                                <img id="url" width="350" height="330" src="img/products/<?php echo $row['prd_image']; ?>">
                                <script>
