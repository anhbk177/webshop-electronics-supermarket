                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center"><img width="250" height="240" src="img/products/<?php echo $row['prd_image']; ?>" /></td>
                                    ...
                                    <td class="form-group">
                                        <a href="index.php?page_layout=<?php if($row['cat_id']==1){echo "edit_prd1";}elseif($row['cat_id']==2){echo "edit_prd3";}else {echo 'edit_prd2';}?>&prd_id=<?php echo $row['prd_id']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
