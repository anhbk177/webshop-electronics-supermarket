...
if (isset($_POST['sbm'])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM category WHERE cat_name='".$cat_name."'" ))) {
        $err_cat = '<div class="alert alert-danger">Danh mục đã tồn tại !</div>';
    }else {
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="post">
                            <div class="form-group">
                                <label>Tên danh mục: <?php echo $row['cat_name'] ?></label>
