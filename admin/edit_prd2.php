...
$sql1 = "SELECT*FROM property_details WHERE prd_id = '$prd_id ' AND pro_id=2";
$query1 = mysqli_query($conn, $sql1);
$row1 = mysqli_fetch_array($query1);

$sql2 = "SELECT*FROM property_details WHERE prd_id = '$prd_id ' AND pro_id=4";
                    ...
                    <div class="col-md-6">
                        <form role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input required name="capacity" value="9 kg" type="text" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Loại máy</label>
                                <select name="type" class="form-control">
                                    <option value=1 ></option>Cửa trên</option>
                                    <option value=0 selected>Cửa ngang</option>
                                </select>
                            </div>
