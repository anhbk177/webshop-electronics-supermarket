...
<meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="module/product/style.css">
    <!-- <script src="module/product/add_cart.js"></script> -->
            ...
            <div id="lienhe">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="hotro"> Hỗ trợ: support@dienlanhtuanbao.tech </div>
                    </div>
                ...
                <?php
                    ...
                    if (isset($_GET['page_layout'])) {
                        switch ($_GET['page_layout']) {
                            ...
                            case 'search_filter'; include_once('module/category/filter.php'); break;
                        }
                    }else {
    ...
    <div id="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <p>
                        Tuan Bao © Copyrights 2021 Công Ty TNHH Tuan Bao
                    </p>
                </div>
            </div>
        </div>
